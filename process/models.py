...
class Project(models.Model):
    ...
    protein_pca = models.JSONField(null=True, blank=True)
    phospho_pca = models.JSONField(null=True, blank=True)
...
class Protein(models.Model):
    ...
    mitotic_cell_cycle = models.BooleanField(default=False)
