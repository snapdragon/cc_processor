# Generated by Django 5.2.1 on 2025-07-19 10:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "proteome_file_accession_number_column_name",
                    models.CharField(max_length=255),
                ),
                ("protein_list", models.JSONField(blank=True, null=True)),
                ("phospho_protein_list", models.JSONField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("pep_tools_annotations", models.JSONField(blank=True, null=True)),
                ("kinase_prediction", models.JSONField(blank=True, null=True)),
                (
                    "protein",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="phospho_protein",
                        to="process.protein",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="replicate_project",
                        to="process.project",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="sample_stage_project",
                        to="process.project",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="sample_stage_replicate",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="column_name_sample_stage",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="statistic_type",
                        to="process.statistictype",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="abundance_replicate",
                        to="process.replicate",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="abundance_sample_stage",
                        to="process.samplestage",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="abundance_statistic",
                        to="process.statistic",
                    ),
                ),
            ],
        ),
            ...
            options={
                "constraints": [
                    models.UniqueConstraint(
                        ...
                        name="unique_uniprot_data_accession_number",
                    )
                ],
            },
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(
                    ("protein__isnull", True), ("phospho__isnull", True)
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(
                    ("project__isnull", True), ("phospho__isnull", True)
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(
                    ("project__isnull", True), ("protein__isnull", True)
                ),
