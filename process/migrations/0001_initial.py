# Generated by Django 5.2.1 on 2025-08-02 16:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protein_pca', models.JSONField(blank=True, null=True)),
                ('phospho_pca', models.JSONField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='StatisticType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('corum_results', models.JSONField(blank=True, null=True)),
                ('GO_locations', models.JSONField(blank=True, null=True)),
                ('mean_gene_effect', models.FloatField(blank=True, null=True)),
